...
<div class="height-100 bg-light">
  <div class="file-header"><h5>Add Roles</h5></div>

  <form action="{{ route('adminAddRolesPost') }}" method="post">@csrf
  <div id="singleFile">
        <div id="card-container" class="card">
          <div class="card-body">
            <div class="row">
              <div class="col-sm-11">
                <input type="text" class="form-control" name="title[]" id="" value="" placeholder="Role title"> 
              </div>
